/**
 * Healthy eating app test created by Lumito.
 * (C) 2020, EQDiet.
...
public final class EQDietAlpha02 extends javax.swing.JFrame{
        ...
        FileWriter fwS=new FileWriter("FoodLog.txt");
            try (BufferedWriter fW = new BufferedWriter(fwS)) {
                do{
                    fW.write("--------------------------------------------------------------");
                    fW.newLine();
                    fW.write("     File generated by EQdiet Alpha. Developed by Lumito.     ");
                    fW.newLine();
                    fW.write("--------------------------------------------------------------");
                    duration = 0;
                }while(duration>0);
        ...
        if(eaten == 2){
            ...
            try (BufferedWriter fS = new BufferedWriter(flS)) {
                do{
                    fS.write("--------------------------------------------------------------");
                    fS.newLine();
                    fS.write("     File generated by EQdiet Alpha. Developed by Lumito.     ");
                    fS.newLine();
                    fS.write("--------------------------------------------------------------");
                    fS.newLine();
                    fS.write("Thanks for using EQDiet Alpha!");
                    fS.newLine();
                    fS.write("Coded by: Lumito.");
                    fS.newLine();
    ...
    */
    ...
    private void initComponents() {
        ...
        jLabel8.setText("Developed by Lumito");
